...
import { LogOut, Moon, Sun, Mail, Crown, Settings, Heart, X, User, Users, Infinity, Phone } from 'lucide-react';
                        ...
                        <div className="bg-white dark:bg-surface-card border border-gray-200 dark:border-border-light rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-sm transition-colors">
                            <div className="flex items-center gap-2 mb-3 sm:mb-4">
                                {user.phoneNumber && !user.email ? (
                                    <Phone size={18} className="text-gray-600 dark:text-gray-400 sm:w-5 sm:h-5" />
                                ) : (
                            ...
                            <div className="space-y-3 sm:space-y-4">
                                ...
                                {user.phoneNumber && (
                                    <div className="p-3 sm:p-4 bg-gray-50 dark:bg-surface rounded-lg">
                                        ...
                                        <p className="text-sm sm:text-base text-gray-900 dark:text-white mt-1 break-all" dir="ltr">{user.phoneNumber}</p>
                                    </div>
                                )}
                                <div className="p-3 sm:p-4 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        <p className={`text-sm sm:text-base font-medium capitalize ${user.subscription === 'premium' ? 'text-purple-600 dark:text-purple-400' :
                        ...
                        <div className="space-y-3">
                            ...
                            {user.phoneNumber && (
                                <div className="p-3 bg-gray-50 dark:bg-surface rounded-lg">
                                    ...
                                    <p className="text-sm text-gray-900 dark:text-white mt-1 break-all" dir="ltr">{user.phoneNumber}</p>
                                </div>
                            )}
                            <div className="p-3 bg-gradient-to-r from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                                ...
                                <div className="flex items-center gap-2 mt-1">
                                    {user.subscription === 'premium' && <Infinity size={16} className="text-purple-600 dark:text-purple-400 animate-pulse" />}
                                    {user.subscription === 'pro' && <Crown size={16} className="text-yellow-600 dark:text-yellow-500" />}
                                    <p className={`text-sm font-medium capitalize ${user.subscription === 'premium' ? 'text-purple-600 dark:text-purple-400' :
                                            user.subscription === 'pro' ? 'text-yellow-600 dark:text-yellow-500' :
                                                'text-gray-900 dark:text-white'
                                        }`}>
                                        {t(`profile.subscriptionStatus.${user.subscription}`)}
