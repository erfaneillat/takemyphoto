    ...
    return (
        <div className="min-h-screen bg-white dark:bg-black pb-20 lg:pb-8 transition-colors" dir="rtl">
            <div className="max-w-2xl mx-auto px-4 py-6">
                {/* Shop Info Card */}
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-2xl p-5 mb-5 border border-purple-100 dark:border-purple-800/30">
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-1.5 mt-1">
                                {shopTypes.map((type) => (
                                    <span
                                        key={type}
                                        className="px-2 py-0.5 text-xs font-medium rounded-full bg-purple-100 dark:bg-purple-800/40 text-purple-700 dark:text-purple-300"
                                    >
                    ...
                    <div className="flex items-center justify-between mt-4 pt-3 border-t border-purple-200/50 dark:border-purple-700/30">
                ...
                <div className="mb-6">
                    <h3 className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-3 flex items-center gap-2">
                        ...
                        تصاویر تولید شده
                        {images.length > 0 && (
                            <span className="bg-purple-100 dark:bg-purple-800/40 text-purple-700 dark:text-purple-300 text-xs px-2 py-0.5 rounded-full">
                                {images.length}
                            </span>
                        )}
                    </h3>
